...
from movie_lens_tfx.ingest_already_split_pyfunc_component import *
...
class MovieLensSplitExampleGenTest(tf.test.TestCase):
  ...
  def test_MovieLensExampleGen(self):
    ...
    PIPELINE_NAME = 'TestMovieLensSplitExampleGen'
    ...
    self.assertTrue(joined_count > 1000 and joined_count < 2000000)
